...
<div class="container">
    ...
    <div class="row">
          ...
          <div class="col-sm-12 text-center">
                  ...
                  <h1> Update Experience Candidate Interview Details</h1>          	
          </div>
    ...
    <br>
	 ...
	 <div class="row">
      ...
      <div class="col-sm-9">
        ...
        <input type="radio" name="toc" value="Experience" onclick="fun_exp()" checked>&nbsp;&nbsp;Experience &nbsp;&nbsp;&nbsp;&nbsp;

        <input type="radio" name="toc" value="Fresher" onclick="fun_fresher()" disabled>&nbsp;&nbsp;Fresher
    ...
    <br>
      ...
      <div class="col-sm-9">
        ...
        <input type="text"  name="companyname" placeholder="Enter Company Name" value="<?php echo $row->companyname; ?>">
    ...
    <div class="row" id="exp_person_salary_id">
      ...
      <div class="col-sm-9">
        ...
        <input type="number"  name="prev_salary" placeholder="Enter the Previous Company Salary" value="<?php echo $row->prev_salary; ?>">
    ...
    <div class="row" id="notice_period_id">
      ...
      <div class="col-sm-9">
            ...
            <input type="text"  name="notice_period" placeholder="Enter the Notice Period in days" value="<?php echo $row->notice_period; ?>">
...
<div class="row">
  ...
  <div class="col-sm-4 text-center">
    ...
    <div class="col-sm-4 text-center">
      <br>
      <input type="submit" name="update_experience_candidate_interview" value="Update Interview Details">
