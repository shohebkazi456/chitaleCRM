  ...
  <a href="go_to_dashboard"><button id="dashid">Go to Dashboard</button></a>
    ...
    <center>
    	...
    	<table border="1" width="80%" cellpadding="7">
         ...
         <tr bgcolor="#006598">
          <th colspan="24"><h1>Retailer Invoice Details</h1></th>
        </tr>
    ...
    echo "<td>
          <button id='btn1'><a href='delete_retailer_invoice?id=".$row->retailer_invoice_id."'>
             Delete 
          </a></button>
        </td>";

    echo "<td>
            <button id='btn2'><a href='update_retailer_invoice?id=".$row->retailer_invoice_id."'>
              Update
            </a></button>
          </td>";  
