...
<body bgcolor="crimson">
   ...
   <center>
   	...
   	<div class="container">
         ...
         <br>
   		...
   		<div class="row">
               ...
               <input type="checkbox" name="supply_for[]" value="Buffalo Milk" id="buffalo" onclick="hideshowfun()">&nbsp;Buffalo Milk
      ...
      <div class="row">
            ...
            <div class="col-sm-4">
               <input type="number" placeholder="Cow Milk quantity" name="cmqty">
            </div>

            <div class="col-sm-4">
               <input type="number" placeholder="Fat in Cow Milk" name="cmfat">
            </div>

            <div class="col-sm-4">
               <input type="number" placeholder="Rate of Cow Milk" name="cmrate" value="30" readonly>
            </div>
      ...
      <div class="row">
             ...
             <div class="col-sm-4">
               <input type="number" placeholder="Buffalo Milk quantity" name="bmqty">
            </div>

            <div class="col-sm-4">
               <input type="number" placeholder="Fat in Buffalo Milk" name="bmfat">
            </div>

            <div class="col-sm-4">
               <input type="number" placeholder="Rate of Buffalo Milk" name="bmrate" value="40" readonly>
            </div>
      ...
      <br><br><br>
   		...
   		<div class="row">
   			...
   			<div class="col-sm-4">
   				<!-- <br> -->
   				<input type="submit" name="registerdailycollection" value="Register Daily Collection">
   			</div>
