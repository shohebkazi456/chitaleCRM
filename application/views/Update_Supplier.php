   ...
   <center>
   	...
   	<div class="container">
   		...
   		<div class="row">
   			...
   			<div class="col-sm-8">
   				<input type="number" placeholder="Contact no of Supplier" name="phoneno" value="<?php echo $row->phoneno; ?>">
   			</div>
   		...
   		<div class="row">
   			...
   			<div class="col-sm-8">
   				<input type="text" placeholder="Address of Supplier" name="address" value="<?php echo $row->address; ?>">
   			</div>
		...
		<br>
   		...
   		<div class="row">
   			...
   			<div class="col-sm-8">
   				<input type="email" placeholder="Email of Supplier" name="email" value="<?php echo $row->email; ?>">
   			</div>
   		...
   		<div class="row">
   			...
   			<div class="col-sm-8">
   				<input type="number" placeholder="Aadhar Card No of Supplier" name="aadharcardno" value="<?php echo $row->aadharcardno; ?>">
   			</div>
   		...
   		<div class="row">
   			...
   			<div class="col-sm-4">
   				<!-- <br> -->
   				<input type="submit" name="updatesupplier" value="Update New Supplier">
   			</div>
