...
<head>
	...
	<script type="text/javascript">
		...
		function calproductunitprice()
		{
			...
			{
				document.f1.unitprice1.value=60;
			}

			if(selectedpname2=="Buffalo Milk")
			{
				document.f1.unitprice2.value=60;
			}

			if(selectedpname3=="Buffalo Milk")
			{
				document.f1.unitprice3.value=60;
			}


			if(selectedpname1=="Amrakhand")
			{
				document.f1.unitprice1.value=220;
			}

			if(selectedpname2=="Amrakhand")
			{
				document.f1.unitprice2.value=220;
			}

			if(selectedpname3=="Amrakhand")
			{
				document.f1.unitprice3.value=220;
			}


			if(selectedpname1=="Shrikhand")
			{
				document.f1.unitprice1.value=280;
			}

			if(selectedpname2=="Shrikhand")
			{
				document.f1.unitprice2.value=280;
			}

			if(selectedpname3=="Shrikhand")
			{
				document.f1.unitprice3.value=280;
			}


			if(selectedpname1=="Shrikhand Dry Fruits")
			{
				document.f1.unitprice1.value=320;
			}

			if(selectedpname2=="Shrikhand Dry Fruits")
			{
				document.f1.unitprice2.value=320;
			}

			if(selectedpname3=="Shrikhand Dry Fruits")
			{
				document.f1.unitprice3.value=320;
			}
   ...
   <center>
   	<br><br>
		<table cellpadding="10" border="1" width="60%">
			...
			<tr>
				<th colspan="2">  
				   <center>	<h2>Invoice Billing For Retailer</h2> </center>
				 </th>
			</tr>
		...
		<table cellpadding="5" border="1" width="60%">
			...
			<tr>
				<td colspan="5" align="center">
					<input type="submit" name="submitretailerinvoice" value="Generate Retailer Invoice">
				</td>
			</tr>
