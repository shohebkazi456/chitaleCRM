	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-12 text-center">
				...
				<h1>New Retailer Customer Registration</h1>
		...
		<div class="row">
			...
			<div class="col-sm-4">
				...
				<label for="email">Email Id</label>
					<input type="email" name="emailid" placeholder="Enter the Email">
			</div>
		...
		<div class="row">
			...
			<div class="col-sm-4">
				...
				<input type="number" name="aadharcardno" placeholder="Enter the Aadhar Card No">
		...
		<div class="row">
			...
			<div class="col-sm-6 text-center">
				...
				<input type="submit" name="registerretailer" value="Register New Retailer">
