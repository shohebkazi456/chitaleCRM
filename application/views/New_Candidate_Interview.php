...
<div class="container">
    ...
    <div class="row">
          ...
          <div class="col-sm-12 text-center">
                  ...
                  <h1> New Candidate Interview Details</h1>          	
          </div>
    ...
    <div class="row" id="exp_person_salary_id">
      ...
      <div class="col-sm-9">
        ...
        <input type="number"  name="prev_salary" placeholder="Enter the Previous Company Salary">
    ...
    <div class="row" id="notice_period_id">
      ...
      <div class="col-sm-9">
            ...
            <input type="text"  name="notice_period" placeholder="Enter the Notice Period in days">
  ...
  <div class="row">
      ...
      <div class="col-sm-3">
       ...
       <div class="col-sm-9">
         ...
         <input type="number" name="salary_expectation" placeholder="Enter Monthly Salary Expectation">
  ...
  <div class="row">
      ...
      <div class="col-sm-3">
       ...
       <div class="col-sm-9">
         ...
         <input type="text" name="hr_remark" placeholder="Enter HR Remark">
...
<div class="row">
  ...
  <div class="col-sm-4 text-center">
    ...
    <div class="col-sm-4 text-center">
      <br>
      <input type="submit" name="submit_candidate_interview" value="Submit Interview Details">
