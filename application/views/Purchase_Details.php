...
<div class="container">
    ...
    <br>
     ...
     <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <input type="number"  name="cop" placeholder="Enter Cost of Product..">
     ...
     <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <input type="number"  name="qty" placeholder="Enter the Product Quantity" autocomplete="off" onkeyup="calCost()">
     ...
     <br>
      ...
      <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <input type="number"  name="pamt" placeholder="Enter Purchase Amount">
    ...
    <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <input type="text"  name="purchaseby" placeholder="Enter Purchase By">  
     ...
     <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <input type="text"  name="pofp" placeholder="Enter Purpose of Purchase">  
...
<div class="row">
    ...
    <div class="col-sm-4 text-center">
      <br>
      <input type="submit" name="submit_purchase_details" value="Submit Data">
