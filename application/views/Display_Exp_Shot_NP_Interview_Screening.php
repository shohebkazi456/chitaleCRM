  ...
  <form method="get">
    ...
    <center>
      ...
      <table border="1" cellpadding="7">
        ...
        <tr bgcolor="#006598">
          <th colspan="19"><h1>Shortest Notice Period Experience Candidate Interview Details</h1></th>
        </tr>
          ...
          <th>Update</th>
             ...
             <?php
                ...
                foreach($data as $row)
                {
                  ...
                  if($row->toc=='Experience' && $row->notice_period<=10)
                  {
                        echo "<tr id='data'>";
                        echo "<td>".$x."</td>";
                        ...
                        echo "<td>
                              <button id='btn1'><a href='delete_interview_screening_short_np?id=".$row->ci_id."'>
                                 Delete 
                              </a></button>
                            </td>";

                          echo "<td>
                                <button id='btn2'><a href='update_interview_screening_short_np?id=".$row->ci_id."'>
                                  Update
                                </a></button>
                              </td>";  
