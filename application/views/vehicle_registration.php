    ...
    <br>
     ...
     <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <input type="text"  name="dname" placeholder="Enter the Driver Name" autocomplete="off">
     ...
     <br>
      ...
      <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <input type="text"  name="lno" placeholder="Enter Licence No">
    ...
    <div class="row">
     ...
     <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <input type="number"  name="aphoneno" placeholder="Enter Alternate Phone No">  
     ...
     <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <input type="number"  name="aadharcardno" placeholder="Enter Aadhar Card No">  
     ...
     <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <input type="radio" name="insurance" id="iyes" value="Yes" onclick="insuranceyes()">&nbsp;&nbsp;Yes &nbsp;&nbsp;&nbsp;&nbsp;

            <input type="radio" name="insurance" id="ino" value="No" onclick="insuranceno()">&nbsp;&nbsp;No 
...
<div class="row">
    ...
    <div class="col-sm-4 text-center">
      <br>
      <input type="submit" name="submit_vehicle_details" value="Submit Data">
