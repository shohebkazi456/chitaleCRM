  ...
  <form method="get">
    ...
    <center>
      ...
      <table border="1" cellpadding="7">
        ...
        <tr bgcolor="#006598">
          <th colspan="19"><h1>Experience Candidate Interview Details</h1></th>
        </tr>
             ...
             <?php
                ...
                foreach($data as $row)
                {
                  ...
                  if($row->toc=='Experience')
                  {
                        ...
                        echo "<td>
                              <button id='btn1'><a href='delete_interview_screening?id=".$row->ci_id."'>
                                 Delete 
                              </a></button>
                            </td>";

                          echo "<td>
                                <button id='btn1'><a href='update_interview_screening?id=".$row->ci_id.",s=''>
                                  Update
                                </a></button>
                              </td>";  
             ...
             <?php
                ...
                foreach($data as $row)
                {
                  ...
                  if($row->toc=='Fresher')
                  {
                        ...
                        echo "<td>
                                <button id='btn1'><a href='update_interview_screening?id=".$row->ci_id."'>
                                  Update
                                </a></button>
                              </td>";  
